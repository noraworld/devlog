...
ちなみに、プロバイダが提供するルータに DHCP 機能が搭載されている場合は、そちらと競合しないように無効にする必要があります。無効にできなくても割り当てる IP アドレスの範囲を極限まで狭めれば実質的に無効化することができます。

詳細に関しては [ルータの条件](https://zenn.dev/noraworld/articles/access-restriction-using-dnsmasq#%E3%83%AB%E3%83%BC%E3%82%BF%E3%81%AE%E6%9D%A1%E4%BB%B6) を参考にしてみてください。
